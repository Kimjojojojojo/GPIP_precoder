...
plt.plot(SNR_dB_range, R_tmp_with_cov_sample_average, label ='GPIP (with cov.)')
plt.plot(SNR_dB_range, R_tmp_without_cov_sample_average, label ='GPIP (without cov.)')
plt.plot(SNR_dB_range, R_tmp_ZF_sample_average, label = 'ZF')
plt.plot(SNR_dB_range, R_tmp_MRT_sample_average, label = 'MRT')
